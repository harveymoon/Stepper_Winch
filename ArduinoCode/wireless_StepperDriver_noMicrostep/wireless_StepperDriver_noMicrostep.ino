...
//const char* DeviceName = "CameraSlide";//"stepper_winch_01";
//const char* DeviceName = "stepper_winch_03";//"stepper_winch_01";
//const char* DeviceName = "Persistence";//"stepper_winch_01";
const char* DeviceName = "simpleStepperDriver";//"stepper_winch_01";
...
AccelStepper stepper(1, D2, D3); // mode, step, dir
